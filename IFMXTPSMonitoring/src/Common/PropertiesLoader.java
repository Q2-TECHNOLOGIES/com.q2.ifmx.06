...
public class PropertiesLoader {
    ...
    public final String tpsType;
    public final int totalMaximumTPS;
    ...
    public PropertiesLoader(String prop_location) throws Exception {
        ...
        try {
            ...
            this.tpsType = this.prop.getProperty("TPSMonitoringType");
            this.totalMaximumTPS = Integer.parseInt(this.prop.getProperty("Max_Error_Notification"));
            ...
            this.recipients = this.prop.getProperty("Email_Address_Recipient");
